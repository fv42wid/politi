  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved candidate as @candidate" do
        ...
        post :create, {:candidate => { "name" => "invalid value" }}, valid_session
        assigns(:candidate).should be_a_new(Candidate)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested candidate" do
        ...
        Candidate.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => candidate.to_param, :candidate => { "name" => "MyString" }}, valid_session
      end
